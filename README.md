...
Cada archivo `.md` es una guía operativa independiente lista para ser incluida en el `playbook` de tu proyecto.
...
**Juan Pablo Gil Ramírez** — Ingeniero Acústico (UACH), Magíster en Modelación Matemática (UFRO). Deputy Manager of Paranal Software Group en el European Southern Observatory (ESO).
